package com.example.zyandeep.contactpickerapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (emgContacts == 0) {
            Snackbar.make(findViewById(R.id.my_constLayout), "ADD EMERGENCY CONTACTS", Snackbar.LENGTH_LONG).show();
        }
        else {
            showContacts();
        }
    ...
    private void showContacts() {
        ...
        for (String key : myContacts.keySet()) {
            ...
            if (!value.isEmpty()) {
                icons[curEmptyView].setImageResource(R.drawable.ic_person_blue);
